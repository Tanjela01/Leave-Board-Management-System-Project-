...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $_SESSION['employee']['gender'] = $updatedGender;
    $_SESSION['employee']['age'] = $updatedAge;
    $_SESSION['employee']['email'] = $updatedEmail;
    $_SESSION['employee']['image'] = $updatedImage;
    ...
    if ($_FILES['profile_picture']['name']) {
        ...
        if (move_uploaded_file($_FILES['profile_picture']['tmp_name'], $targetFile)) {
            $_SESSION['employee']['image'] = $targetFile;
        } else {
            $error = "Error uploading profile picture.";
        }
    }

    $updateQuery = "UPDATE member SET name='$updatedName', gender='$updatedGender', age='$updatedAge', contact='$updatedEmail', password='$updatedPassword', image='$targetFile' WHERE role='Employee' AND id='$id'";
