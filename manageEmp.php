...
<body>
    ...
    <div class="content" style="height:82.7vh;width:1720px;border:5px solid white;margin-left:200px;">
        ...
        <div class="history"
            ...
            <h3 style="color:white;"><i class="fa-solid fa-users" style="color:white"></i>
                Employee List </h3>
            ...
            <div class="scrollable-table" style="height:680px;overflow:auto;">
                <table id="dtDynamicVerticalScrollExample" class="table table-striped table-bordered table-sm"
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM member where role='Employee'";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>
                            <a href='modEmp.php?id=" . $row['id'] . "'><button type='button' class='btn btn-primary btn-sm'>Modify</button></a>
